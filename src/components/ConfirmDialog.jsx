...
export default function ConfirmDialog({ title, message, onConfirm, onCancel }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4" role="dialog" aria-modal="true">
      ...
      <div className="relative w-full max-w-sm surface-floating p-6 animate-scale-in">
        ...
        <div className="flex items-center justify-end gap-3 pt-2 border-t border-stone-200/70 mt-2">
